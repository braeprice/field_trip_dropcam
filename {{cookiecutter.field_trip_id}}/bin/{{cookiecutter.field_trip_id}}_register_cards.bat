...
call "%LOCALAPPDATA%\anaconda3\Scripts\activate.bat" || call "%LOCALAPPDATA%\miniconda3\Scripts\activate.bat" || call "%USERPROFILE%\anaconda3\Scripts\activate.bat" || call "%USERPROFILE%\miniconda3\Scripts\activate.bat" || (
