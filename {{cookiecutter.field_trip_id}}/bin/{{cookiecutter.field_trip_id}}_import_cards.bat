...
call "%LOCALAPPDATA%\anaconda3\Scripts\activate.bat" || "%LOCALAPPDATA%\miniconda3\Scripts\activate.bat" || "%USERPROFILE%\anaconda3\Scripts\activate.bat" || call "%USERPROFILE%\miniconda3\Scripts\activate.bat" || (
